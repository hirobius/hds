...
export const LegacyStrongProp: Story = {
  parameters: {
    docs: {
      description: {
        story:
          'The boolean `strong` prop still works for backward compatibility — it maps onto variant="strong" internally. Prefer `variant` in new code.',
      },
    },
  },
