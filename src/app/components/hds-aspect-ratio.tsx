/**
 * HdsAspectRatio — constrains its child to a fixed width:height ratio.
 * @category Layout
 * @tier primitive
 *
...
/** @public */
export interface HdsAspectRatioProps extends React.ComponentPropsWithoutRef<
 ...
 */
export const HdsAspectRatio = React.forwardRef<
  React.ElementRef<typeof AspectRatioPrimitive.Root>,
  HdsAspectRatioProps
>(function HdsAspectRatio({ ratio = 1, ...props }, ref) {
