/**
 * HdsContextMenu — right-click context menu on Radix ContextMenu.
 * @category Overlays
 * @tier primitive
 ...
 *       <HdsContextMenu.Item onSelect={…}>Cut</HdsContextMenu.Item>
...
interface HdsContextMenuComponent extends React.FC<
 ...
 * `HdsContextMenu.Trigger`. Controlled via `onOpenChange`.
 * @public
 */
export const HdsContextMenu = ((props: React.ComponentProps<typeof ContextMenuPrimitive.Root>) => (
  <ContextMenuRoot {...props} />
)) as HdsContextMenuComponent;
HdsContextMenu.Trigger = ContextMenuTrigger;
HdsContextMenu.Content = ContextMenuContent;
HdsContextMenu.Item = ContextMenuItem;
HdsContextMenu.CheckboxItem = ContextMenuCheckboxItem;
HdsContextMenu.RadioGroup = ContextMenuRadioGroup;
HdsContextMenu.RadioItem = ContextMenuRadioItem;
HdsContextMenu.Label = ContextMenuLabel;
HdsContextMenu.Separator = ContextMenuSeparator;
HdsContextMenu.Group = ContextMenuGroup;
HdsContextMenu.Sub = ContextMenuSub;
HdsContextMenu.SubTrigger = ContextMenuSubTrigger;
HdsContextMenu.SubContent = ContextMenuSubContent;
