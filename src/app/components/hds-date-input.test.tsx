/**
 * Tests for HdsDateInput — formatted value display, opening the calendar
...
import { HdsDateInput } from './hds-date-input';
...
describe('HdsDateInput', () => {
  ...
  it('calls onChange with a Date when a day is selected', () => {
    ...
    render(<HdsDateInput value={new Date('2026-07-01')} onChange={onChange} aria-label="Date" />);
    fireEvent.click(screen.getByRole('button', { name: 'Open calendar' }));
