/**
 * HdsToggleButton — a two-state (on/off) pressable button on Radix Toggle.
 * @category Actions
 * @tier primitive
 *
 ...
 *
 *   <HdsToggleButton aria-label="Bold" pressed={bold} onPressedChange={setBold}>
 *     <Bold />
 *   </HdsToggleButton>
 */
...
type HdsToggleButtonVariantProps = VariantProps<typeof hdsToggleButtonVariants>;

/** @public */
export interface HdsToggleButtonProps
  extends
    React.ComponentPropsWithoutRef<typeof TogglePrimitive.Root>,
    HdsToggleButtonVariantProps {}
 ...
 */
export const HdsToggleButton = React.forwardRef<
  React.ElementRef<typeof TogglePrimitive.Root>,
  HdsToggleButtonProps
>(function HdsToggleButton({ className, variant, size, ...props }, ref) {
  return (
...
/** @internal — CVA variant helper; compose via HdsToggleButton props instead. */
