/**
 * DateTimeInput — combined date + time field pairing a text date input with
 ...
 * @public
 *
 * Composes the HDS Popover (trigger = calendar icon button) with Calendar
 * for the date grid, and TimeInput for the time-of-day, keeping both parts
