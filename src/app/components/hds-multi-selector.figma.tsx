/**
 * HdsMultiSelector — Figma Code Connect stub (ADR-019 phase c / #47).
 *
...
// import { HdsMultiSelector } from './hds-multi-selector';
//
// figma.connect(HdsMultiSelector, 'FIGMA_NODE_URL', {
//   example: () => <HdsMultiSelector />,
// });
