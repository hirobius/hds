/**
 * Tests for DateTimeInput — date text field, calendar popover, and the
...
describe('DateTimeInput', () => {
  it('renders a date text input and a time input', () => {
    render(<DateTimeInput aria-label="Appointment" />);
  ...
  it('shows the formatted date and time when value is set', () => {
    render(<DateTimeInput value={new Date('2026-07-15T09:30')} aria-label="Appointment" />);
    const dateInput = screen.getByLabelText('Appointment') as HTMLInputElement;
