/**
 * HdsMultiSelector — multi-select dropdown composing the existing Popover with
...
/** @public */
export interface HdsMultiSelectorOption {
  value: string;
  label: string;
}

/** @public */
export interface HdsMultiSelectorProps {
  /** Selectable options. */
  options: HdsMultiSelectorOption[];
...
/** @public */
export const HdsMultiSelector = React.forwardRef<HTMLButtonElement, HdsMultiSelectorProps>(
  function HdsMultiSelector(
