...
const segmentedControlLabelVariants = cva(
  ...
  'relative z-[var(--primitive-zIndex-10)] max-w-[60ch] text-[14px] font-medium leading-5 text-current',
);
    ...
    return (
      <div ref={ref} className={segmentedControlWrapperVariants({ fullWidth })}>
        {label && (
          ...
          <span
            // eslint-disable-next-line tailwindcss/no-arbitrary-value -- typeStyles.ui composite (14px/20px/medium/60ch, hds#283: was 15px/24px) + content-primary color have no Tailwind-theme utility; var()-based so still token-driven
            className="max-w-[60ch] text-[14px] font-medium leading-5 text-[var(--semantic-color-content-primary)]"
