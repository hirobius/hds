/**
 * MetadataList — Figma Code Connect stub (ADR-019 phase c / #47).
 *
...
//
// figma.connect(MetadataList, 'FIGMA_NODE_URL', {
//   example: () => <MetadataList items={[{ term: 'Status', description: 'Active' }]} />,
// });
