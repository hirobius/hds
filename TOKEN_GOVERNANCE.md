...
5. if follow-up work remains, file it as a GitHub Issue in this repo (fleet-hub convention, see `CLAUDE.md`)
6. update process/decision archive only if Adrian explicitly asks for that documentation
