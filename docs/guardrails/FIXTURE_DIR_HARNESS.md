...
| Manifest-dependent   | audit-tokens, check-manifest-drift, check-binding-drift, check-asset-manifest, check-attributions, audit-batch-deliverables                                 | read `public/hds-manifest.json` / `public/assets/manifest.json`                       |
