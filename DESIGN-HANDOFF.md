...
| `h2`              | 30px       | 700    | 42px        | -0.01em        | Secondary section headings (h2). Satoshi Bold, 30px, line-height 42px.     |
| `h3`              | 20px       | 700    | 28px        | 0em            | Component and card headers (h3). 20px / Satoshi Bold 700 / leading-snug.   |
