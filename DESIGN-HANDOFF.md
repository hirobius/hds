...
Checks all 405 tokens, aliases, and TS refs in one shot.
...
| `semantic.color.owner.a.surface`        | {primitive.color.violet.50}     | {primitive.color.violet.950}    | Owner-chip A (violet) surface — ground for a named-party tag (two-party responsibility chips). |
| `semantic.color.owner.a.content`        | {primitive.color.violet.700}    | {primitive.color.violet.400}    | Owner-chip A (violet) content/ink — AA on its own surface in both themes.                      |
| `semantic.color.owner.b.surface`        | {primitive.color.blue.50}       | {primitive.color.blue.900}      | Owner-chip B (blue) surface.                                                                   |
| `semantic.color.owner.b.content`        | {primitive.color.blue.700}      | {primitive.color.blue.300}      | Owner-chip B (blue) content/ink.                                                               |
